...
public class Research extends Material {
    ...
    public Research(int mat_id, int stu_id, int judge_id, int ac_year, int mat_type, int eval_status, String remark, String file_url, Date submit_time, Date eval_time, String output_name, int output_type, String category, int ranking, int level, Date output_time) {
